...
# Catalog Service — E-Commerce Microservices Architecture
...
## 📌 Overview
`catalog-service` is part of a polyglot microservices architecture for an e-commerce platform.  
This skeleton provides:
- Health endpoint (`GET /api/catalog/health`)
